...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/bitcoinfinal/bitcoinfinal-android/releases";

    public static final String VERSION_URL = "https://bitcoinfinal.net/version";
    public static final String SUPPORT_EMAIL = "support@bitcoinfinal.com";
    ...
    static {
		...
		COINS_BLOCK_EXPLORERS.put(CoinID.BITCOINFINAL_MAIN.getCoinType(), "https://btcf.ccore.online/transaction/%s");
