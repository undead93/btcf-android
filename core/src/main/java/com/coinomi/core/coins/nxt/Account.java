...
//                + " existing key " + com.bitcoinfinal.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.bitcoinfinal.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.bitcoinfinal.core.coins.nxt.Crypto.rsDecode(com.bitcoinfinal.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.bitcoinfinal.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.bitcoinfinal.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.bitcoinfinal.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.bitcoinfinal.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.bitcoinfinal.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.bitcoinfinal.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
